  ...
  return (
    <section className="w-full flex justify-center items-center pt-16 bg-white z-10 relative overflow-hidden">
      ...
      <span
        ...
        aria-hidden="true"
      />
      <div className="w-full max-w-[1440px] px-6 md:px-36 inline-flex flex-col justify-start items-center">
        ...
        <div className="w-full max-w-[1152px] p-6 md:p-6 bg-gradient-to-r from-[#3F71B7] to-[#3365AC] rounded-[32px] flex flex-col justify-start items-start gap-6 overflow-hidden relative shadow-lg">
          ...
          <div className="hidden md:block absolute right-12 top-1/2 -translate-y-1/2 w-[192px] h-[144px] pointer-events-none z-0">
            <Image
